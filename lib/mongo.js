...
// const MONGO_URI = `mongodb://${config.dbHost}:${config.port}/${DB_NAME}?retryWrites=true&w=majority`;
const MONGO_URI = `mongodb+srv://${USER}:${PASSWORD}@${config.dbHost}/${DB_NAME}?retryWrites=true&w=majority`;
//mongodb+srv://<username>:<password>@cluster0.e1gib.mongodb.net/<dbname>?retryWrites=true&w=majority
...
class MongoLib {
  ...
  updated(collection, id, data) {
    return this.connect()
      ...
      .then((result) => result.upsertdId || id);
  }
